...
from openerp.addons.payment_alipay.models import func
...
class AlipayController(http.Controller):
    ...
    def _get_return_url(self, **post):
        ...
        # return_url = post.pop('out_trade_no', '')
        # if not return_url:
        # out_trade_no = json.loads(post.pop('out_trade_no', False) or '{}')
        # return_url = out_trade_no.get('out_trade_no', '/shop/confirmation')
